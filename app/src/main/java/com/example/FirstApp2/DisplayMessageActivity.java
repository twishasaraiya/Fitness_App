...
public class DisplayMessageActivity extends YouTubeBaseActivity implements View.OnClickListener,TextToSpeech.OnInitListener,YouTubePlayer.OnInitializedListener {

    private TextView[] mtextView;  // timer textView to display seconds remaining
    ...
    // get values from intent.getExtra()
    String speechText[]={};
    String videoIds[] ={};
    String text[]={};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speechText=extras.getStringArray("text");
        videoIds=extras.getStringArray("VideoIds");
        text=extras.getStringArray("text");
